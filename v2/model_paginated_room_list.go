...
// checks if the PaginatedRoomList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedRoomList{}
...
func (o PaginatedRoomList) ToMap() (map[string]interface{}, error) {
