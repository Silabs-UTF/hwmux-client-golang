...
func (a *GroupsAPIService) GroupsAvailableListExecute(r ApiGroupsAvailableListRequest) (*PaginatedDeviceGroupList, *http.Response, error) {
	...
	if r.enableAhs != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "enable_ahs", r.enableAhs, "")
	}
	if r.enableAhsActions != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "enable_ahs_actions", r.enableAhsActions, "")
	}
	if r.enableAhsCas != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "enable_ahs_cas", r.enableAhsCas, "")
	}
	if r.idIn != nil {
