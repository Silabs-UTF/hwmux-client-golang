...
// checks if the PatchedLabelSerializerWithPermissions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedLabelSerializerWithPermissions{}
...
func (o PatchedLabelSerializerWithPermissions) ToMap() (map[string]interface{}, error) {
