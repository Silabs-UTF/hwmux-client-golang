...
func (r ApiLogsListRequest) DateAfter(dateAfter time.Time) ApiLogsListRequest {
	r.dateAfter = &dateAfter
	return r
}

func (r ApiLogsListRequest) DateBefore(dateBefore time.Time) ApiLogsListRequest {
...
func (r ApiLogsListRequest) DeviceGroupLabelName(deviceGroupLabelName string) ApiLogsListRequest {
	r.deviceGroupLabelName = &deviceGroupLabelName
	return r
}
...
func (r ApiLogsListRequest) Ordering(ordering string) ApiLogsListRequest {
	r.ordering = &ordering
	return r
}
...
func (r ApiLogsListRequest) ResourceName(resourceName string) ApiLogsListRequest {
	r.resourceName = &resourceName
	return r
}

func (r ApiLogsListRequest) ResourceNameList(resourceNameList string) ApiLogsListRequest {
	r.resourceNameList = &resourceNameList
	return r
}

func (r ApiLogsListRequest) ResourceType(resourceType string) ApiLogsListRequest {
...
func (r ApiLogsListRequest) Status(status string) ApiLogsListRequest {
	r.status = &status
	return r
}
...
func (a *LogsApiService) LogsListExecute(r ApiLogsListRequest) (*PaginatedLogList, *http.Response, error) {
	...
	if r.deviceGroup != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				localVarQueryParams.Add("device_group", parameterToString(s.Index(i), "multi"))
			}
		} else {
			localVarQueryParams.Add("device_group", parameterToString(t, "multi"))
		}
	}
	...
	if r.deviceGroupLabel != nil {
		t := *r.deviceGroupLabel
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				localVarQueryParams.Add("device_group_label", parameterToString(s.Index(i), "multi"))
			}
		} else {
			localVarQueryParams.Add("device_group_label", parameterToString(t, "multi"))
		}
	}
	if r.deviceGroupLabelName != nil {
		localVarQueryParams.Add("device_group_label__name", parameterToString(*r.deviceGroupLabelName, ""))
	}
	if r.event != nil {
	...
	if r.resourceNameList != nil {
		localVarQueryParams.Add("resource_name_list", parameterToString(*r.resourceNameList, ""))
	}
