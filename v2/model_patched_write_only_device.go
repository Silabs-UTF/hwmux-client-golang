...
// checks if the PatchedWriteOnlyDevice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedWriteOnlyDevice{}
...
func (o PatchedWriteOnlyDevice) ToMap() (map[string]interface{}, error) {
