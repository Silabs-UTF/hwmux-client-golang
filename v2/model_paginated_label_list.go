...
// checks if the PaginatedLabelList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedLabelList{}
...
func (o PaginatedLabelList) ToMap() (map[string]interface{}, error) {
