...
// checks if the PaginatedPartFamilyList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedPartFamilyList{}
...
func (o PaginatedPartFamilyList) ToMap() (map[string]interface{}, error) {
