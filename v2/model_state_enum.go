...
// StateEnum * `CRE_PEND` - CRE_PEND * `QUE` - QUE * `RES_PEND` - RES_PEND * `ACT` - ACT * `CAN_PEND` - CAN_PEND * `REL_PEND` - REL_PEND * `FIN` - FIN * `EXP_PEND` - EXP_PEND * `EXP` - EXP * `FAIL` - FAIL
type StateEnum string

// List of StateEnum
const (
	STATEENUM_CRE_PEND StateEnum = "CRE_PEND"
	STATEENUM_QUE StateEnum = "QUE"
	STATEENUM_RES_PEND StateEnum = "RES_PEND"
	STATEENUM_ACT StateEnum = "ACT"
	STATEENUM_CAN_PEND StateEnum = "CAN_PEND"
	STATEENUM_REL_PEND StateEnum = "REL_PEND"
	STATEENUM_FIN StateEnum = "FIN"
	STATEENUM_EXP_PEND StateEnum = "EXP_PEND"
	STATEENUM_EXP StateEnum = "EXP"
	STATEENUM_FAIL StateEnum = "FAIL"
)
