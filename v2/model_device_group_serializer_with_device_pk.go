...
// checks if the DeviceGroupSerializerWithDevicePk type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceGroupSerializerWithDevicePk{}
...
type _DeviceGroupSerializerWithDevicePk DeviceGroupSerializerWithDevicePk
...
func (o DeviceGroupSerializerWithDevicePk) ToMap() (map[string]interface{}, error) {
...
func (o *DeviceGroupSerializerWithDevicePk) UnmarshalJSON(bytes []byte) (err error) {
	...
	varDeviceGroupSerializerWithDevicePk := _DeviceGroupSerializerWithDevicePk{}

	err = json.Unmarshal(bytes, &varDeviceGroupSerializerWithDevicePk)

	if err != nil {
		return err
	}

	*o = DeviceGroupSerializerWithDevicePk(varDeviceGroupSerializerWithDevicePk)
