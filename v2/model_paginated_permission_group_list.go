...
// checks if the PaginatedPermissionGroupList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedPermissionGroupList{}
...
type PaginatedPermissionGroupList struct {
	...
	Results []PermissionGroup `json:"results,omitempty"`
}
...
// SetResults gets a reference to the given []PermissionGroup and assigns it to the Results field.
...
func (o PaginatedPermissionGroupList) ToMap() (map[string]interface{}, error) {
