...
type ReservationRequest struct {
	...
	LeaseDurationS NullableInt32 `json:"lease_duration_s,omitempty"`
}
...
// GetLeaseDurationS returns the LeaseDurationS field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ReservationRequest) GetLeaseDurationS() int32 {
	if o == nil || isNil(o.LeaseDurationS.Get()) {
		var ret int32
		return ret
	}
	return *o.LeaseDurationS.Get()
}

// GetLeaseDurationSOk returns a tuple with the LeaseDurationS field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetLeaseDurationS gets a reference to the given NullableInt32 and assigns it to the LeaseDurationS field.
func (o *ReservationRequest) SetLeaseDurationS(v int32) {
	o.LeaseDurationS.Set(&v)
}
// SetLeaseDurationSNil sets the value for LeaseDurationS to be an explicit nil
func (o *ReservationRequest) SetLeaseDurationSNil() {
	o.LeaseDurationS.Set(nil)
}
...
func (o ReservationRequest) MarshalJSON() ([]byte, error) {
	...
	if o.LeaseDurationS.IsSet() {
		toSerialize["lease_duration_s"] = o.LeaseDurationS.Get()
	}
