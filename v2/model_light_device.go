...
// checks if the LightDevice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LightDevice{}
...
func (o LightDevice) ToMap() (map[string]interface{}, error) {
...
func (o *LightDevice) UnmarshalJSON(bytes []byte) (err error) {
	...
	varLightDevice := _LightDevice{}

	err = json.Unmarshal(bytes, &varLightDevice)

	if err != nil {
		return err
	}

	*o = LightDevice(varLightDevice)
