...
// checks if the PaginatedLogList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedLogList{}
...
func (o PaginatedLogList) ToMap() (map[string]interface{}, error) {
