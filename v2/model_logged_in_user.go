...
// checks if the LoggedInUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LoggedInUser{}
...
type _LoggedInUser LoggedInUser
...
func (o LoggedInUser) ToMap() (map[string]interface{}, error) {
...
func (o *LoggedInUser) UnmarshalJSON(bytes []byte) (err error) {
	...
	varLoggedInUser := _LoggedInUser{}

	err = json.Unmarshal(bytes, &varLoggedInUser)

	if err != nil {
		return err
	}

	*o = LoggedInUser(varLoggedInUser)
