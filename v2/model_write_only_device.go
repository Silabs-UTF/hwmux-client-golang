...
// checks if the WriteOnlyDevice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WriteOnlyDevice{}
...
type _WriteOnlyDevice WriteOnlyDevice
...
func (o WriteOnlyDevice) ToMap() (map[string]interface{}, error) {
...
func (o *WriteOnlyDevice) UnmarshalJSON(bytes []byte) (err error) {
	...
	varWriteOnlyDevice := _WriteOnlyDevice{}

	err = json.Unmarshal(bytes, &varWriteOnlyDevice)

	if err != nil {
		return err
	}

	*o = WriteOnlyDevice(varWriteOnlyDevice)
