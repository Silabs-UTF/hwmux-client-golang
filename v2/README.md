...
*DjangoLoginApi* | [**DjangoLoginCreate**](docs/DjangoLoginApi.md#djangologincreate) | **Post** /django_login/ | 
*ExternalSigninApi* | [**ExternalSigninRetrieve**](docs/ExternalSigninApi.md#externalsigninretrieve) | **Get** /external_signin/ | 
...
*OutboxApi* | [**OutboxList**](docs/OutboxApi.md#outboxlist) | **Get** /api/outbox/ | 
*OutboxApi* | [**OutboxRetrieve**](docs/OutboxApi.md#outboxretrieve) | **Get** /api/outbox/{id}/ | 
...
*ReservationsApi* | [**ReservationsExtendUpdate**](docs/ReservationsApi.md#reservationsextendupdate) | **Put** /api/reservations/{id}/extend/ | 
