...
// checks if the PaginatedReservationSessionSerializerReadOnlyList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedReservationSessionSerializerReadOnlyList{}
...
func (o PaginatedReservationSessionSerializerReadOnlyList) ToMap() (map[string]interface{}, error) {
