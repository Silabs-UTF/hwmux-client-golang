...
Adds object-level permissions management as detail views
...
func (r ApiDevicesListRequest) ForceMv(forceMv string) ApiDevicesListRequest {
	r.forceMv = &forceMv
	return r
}
...
func (r ApiDevicesListRequest) IncludePermissionGroups(includePermissionGroups bool) ApiDevicesListRequest {
	r.includePermissionGroups = &includePermissionGroups
	return r
}

func (r ApiDevicesListRequest) IsReserved(isReserved bool) ApiDevicesListRequest {
	r.isReserved = &isReserved
	return r
}

func (r ApiDevicesListRequest) IsReservedFilter(isReservedFilter bool) ApiDevicesListRequest {
	r.isReservedFilter = &isReservedFilter
	return r
}
...
func (r ApiDevicesListRequest) SocketedChip(socketedChip string) ApiDevicesListRequest {
	r.socketedChip = &socketedChip
	return r
}

// * &#x60;TERRAFORM&#x60; - Terraform * &#x60;XML&#x60; - XML * &#x60;UI&#x60; - UI * &#x60;OTHER&#x60; - Other
func (r ApiDevicesListRequest) Source(source string) ApiDevicesListRequest {
	r.source = &source
	return r
}

// * &#x60;ACTIVE&#x60; - Active * &#x60;DISABLED&#x60; - Disabled * &#x60;OFFLINE&#x60; - Offline
...
func (a *DevicesApiService) DevicesListExecute(r ApiDevicesListRequest) (*PaginatedDeviceSerializerPublicList, *http.Response, error) {
	...
	if r.isReserved != nil {
		localVarQueryParams.Add("is_reserved", parameterToString(*r.isReserved, ""))
	}
	if r.isReservedFilter != nil {
		localVarQueryParams.Add("is_reserved_filter", parameterToString(*r.isReservedFilter, ""))
	}
	if r.isWstk != nil {
	...
	if r.socketedChip != nil {
		localVarQueryParams.Add("socketed_chip", parameterToString(*r.socketedChip, ""))
	}
	if r.source != nil {
...
// If set to true, the permission groups associated with this resource will be included in the response. Defaults to false.
func (r ApiDevicesListMyListRequest) IncludePermissionGroups(includePermissionGroups bool) ApiDevicesListMyListRequest {
	r.includePermissionGroups = &includePermissionGroups
	return r
}

func (r ApiDevicesListMyListRequest) IsReserved(isReserved bool) ApiDevicesListMyListRequest {
	r.isReserved = &isReserved
	return r
}

func (r ApiDevicesListMyListRequest) IsReservedFilter(isReservedFilter bool) ApiDevicesListMyListRequest {
	r.isReservedFilter = &isReservedFilter
	return r
}
...
func (r ApiDevicesListMyListRequest) SocketedChip(socketedChip string) ApiDevicesListMyListRequest {
	r.socketedChip = &socketedChip
	return r
}

// * &#x60;TERRAFORM&#x60; - Terraform * &#x60;XML&#x60; - XML * &#x60;UI&#x60; - UI * &#x60;OTHER&#x60; - Other
func (r ApiDevicesListMyListRequest) Source(source string) ApiDevicesListMyListRequest {
	r.source = &source
	return r
}
...
// If set to true, the permission groups associated with this resource will be included in the response. Defaults to false.
func (r ApiDevicesRetrieveRequest) IncludePermissionGroups(includePermissionGroups bool) ApiDevicesRetrieveRequest {
	r.includePermissionGroups = &includePermissionGroups
	return r
}
...
func (r ApiDevicesSearchListRequest) IsReserved(isReserved bool) ApiDevicesSearchListRequest {
	r.isReserved = &isReserved
	return r
}

func (r ApiDevicesSearchListRequest) IsReservedFilter(isReservedFilter bool) ApiDevicesSearchListRequest {
	r.isReservedFilter = &isReservedFilter
	return r
}
...
func (r ApiDevicesSearchListRequest) SocketedChip(socketedChip string) ApiDevicesSearchListRequest {
	r.socketedChip = &socketedChip
	return r
}

// * &#x60;TERRAFORM&#x60; - Terraform * &#x60;XML&#x60; - XML * &#x60;UI&#x60; - UI * &#x60;OTHER&#x60; - Other
func (r ApiDevicesSearchListRequest) Source(source string) ApiDevicesSearchListRequest {
	r.source = &source
	return r
}
