...
func (a *DevicesAPIService) DevicesListExecute(r ApiDevicesListRequest) (*PaginatedDeviceSerializerPublicList, *http.Response, error) {
	...
	if r.dateCreated != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "date_created", r.dateCreated, "")
	}
	if r.forceMv != nil {
	...
	if r.isWstk != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "is_wstk", r.isWstk, "")
	}
	if r.lastUpdate != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "last_update", r.lastUpdate, "")
	}
	if r.online != nil {
	...
	if r.snOrName != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "sn_or_name", r.snOrName, "")
	}
	if r.snOrNameIsnull != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "sn_or_name__isnull", r.snOrNameIsnull, "")
	}
	if r.status != nil {
	...
	if r.uriIsnull != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "uri__isnull", r.uriIsnull, "")
	}
	if r.wstkPart != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "wstk_part", r.wstkPart, "")
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
func (a *DevicesAPIService) DevicesLocationRetrieveExecute(r ApiDevicesLocationRetrieveRequest) (*Location, *http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"device_pk"+"}", url.PathEscape(parameterValueToString(r.devicePk, "devicePk")), -1)
...
func (a *DevicesAPIService) DevicesSearchListExecute(r ApiDevicesSearchListRequest) (*PaginatedDeviceSerializerPublicList, *http.Response, error) {
	...
	parameterAddToHeaderOrQuery(localVarQueryParams, "search_key_value_pairs", r.searchKeyValuePairs, "")
	if r.site != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "site", r.site, "")
	}
	if r.snOrName != nil {
