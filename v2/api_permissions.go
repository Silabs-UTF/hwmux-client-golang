...
type ApiPermissionsGroupsDestroyRequest struct {
	ctx context.Context
	ApiService *PermissionsAPIService
	nameOrId string
}

func (r ApiPermissionsGroupsDestroyRequest) Execute() (*http.Response, error) {
	return r.ApiService.PermissionsGroupsDestroyExecute(r)
}

/*
PermissionsGroupsDestroy Method for PermissionsGroupsDestroy

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param nameOrId
 @return ApiPermissionsGroupsDestroyRequest
*/
func (a *PermissionsAPIService) PermissionsGroupsDestroy(ctx context.Context, nameOrId string) ApiPermissionsGroupsDestroyRequest {
	return ApiPermissionsGroupsDestroyRequest{
		ApiService: a,
		ctx: ctx,
		nameOrId: nameOrId,
...
// Execute executes the request
func (a *PermissionsAPIService) PermissionsGroupsDestroyExecute(r ApiPermissionsGroupsDestroyRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PermissionsAPIService.PermissionsGroupsDestroy")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/permissions/groups/{name_or_id}/"
	localVarPath = strings.Replace(localVarPath, "{"+"name_or_id"+"}", url.PathEscape(parameterValueToString(r.nameOrId, "nameOrId")), -1)
...
*/
func (a *PermissionsAPIService) PermissionsGroupsDeviceGroupsCreate(ctx context.Context, nameOrId string) ApiPermissionsGroupsDeviceGroupsCreateRequest {
	return ApiPermissionsGroupsDeviceGroupsCreateRequest{
		ApiService: a,
		ctx: ctx,
		nameOrId: nameOrId,
...
func (a *PermissionsAPIService) PermissionsGroupsDeviceGroupsCreateExecute(r ApiPermissionsGroupsDeviceGroupsCreateRequest) (*PermissionGroup, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/permissions/groups/{name_or_id}/device_groups/"
	localVarPath = strings.Replace(localVarPath, "{"+"name_or_id"+"}", url.PathEscape(parameterValueToString(r.nameOrId, "nameOrId")), -1)
...
*/
func (a *PermissionsAPIService) PermissionsGroupsDeviceGroupsDestroy(ctx context.Context, id int32, nameOrId string) ApiPermissionsGroupsDeviceGroupsDestroyRequest {
	return ApiPermissionsGroupsDeviceGroupsDestroyRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *PermissionsAPIService) PermissionsGroupsDeviceGroupsDestroyExecute(r ApiPermissionsGroupsDeviceGroupsDestroyRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/api/permissions/groups/{name_or_id}/device_groups/{id}/"
...
*/
func (a *PermissionsAPIService) PermissionsGroupsDeviceGroupsList(ctx context.Context, nameOrId string) ApiPermissionsGroupsDeviceGroupsListRequest {
	return ApiPermissionsGroupsDeviceGroupsListRequest{
		ApiService: a,
		ctx: ctx,
		nameOrId: nameOrId,
...
func (a *PermissionsAPIService) PermissionsGroupsDeviceGroupsListExecute(r ApiPermissionsGroupsDeviceGroupsListRequest) (*PaginatedDeviceGroupList, *http.Response, error) {
	...
	if r.perms != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "perms", r.perms, "")
	} else {
		var defaultValue string = "view,change,add,delete"
		r.perms = &defaultValue
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{}
...
*/
func (a *PermissionsAPIService) PermissionsGroupsDeviceGroupsPartialUpdate(ctx context.Context, id int32, nameOrId string) ApiPermissionsGroupsDeviceGroupsPartialUpdateRequest {
	return ApiPermissionsGroupsDeviceGroupsPartialUpdateRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
*/
func (a *PermissionsAPIService) PermissionsGroupsDeviceGroupsUpdate(ctx context.Context, id int32, nameOrId string) ApiPermissionsGroupsDeviceGroupsUpdateRequest {
	return ApiPermissionsGroupsDeviceGroupsUpdateRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
*/
func (a *PermissionsAPIService) PermissionsGroupsDevicesCreate(ctx context.Context, nameOrId string) ApiPermissionsGroupsDevicesCreateRequest {
	return ApiPermissionsGroupsDevicesCreateRequest{
		ApiService: a,
		ctx: ctx,
		nameOrId: nameOrId,
...
func (a *PermissionsAPIService) PermissionsGroupsDevicesCreateExecute(r ApiPermissionsGroupsDevicesCreateRequest) (*PermissionGroup, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/permissions/groups/{name_or_id}/devices/"
	localVarPath = strings.Replace(localVarPath, "{"+"name_or_id"+"}", url.PathEscape(parameterValueToString(r.nameOrId, "nameOrId")), -1)
...
*/
func (a *PermissionsAPIService) PermissionsGroupsDevicesDestroy(ctx context.Context, id int32, nameOrId string) ApiPermissionsGroupsDevicesDestroyRequest {
	return ApiPermissionsGroupsDevicesDestroyRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *PermissionsAPIService) PermissionsGroupsDevicesDestroyExecute(r ApiPermissionsGroupsDevicesDestroyRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/api/permissions/groups/{name_or_id}/devices/{id}/"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"name_or_id"+"}", url.PathEscape(parameterValueToString(r.nameOrId, "nameOrId")), -1)
...
*/
func (a *PermissionsAPIService) PermissionsGroupsDevicesList(ctx context.Context, nameOrId string) ApiPermissionsGroupsDevicesListRequest {
	return ApiPermissionsGroupsDevicesListRequest{
		ApiService: a,
		ctx: ctx,
		nameOrId: nameOrId,
...
*/
func (a *PermissionsAPIService) PermissionsGroupsDevicesPartialUpdate(ctx context.Context, id int32, nameOrId string) ApiPermissionsGroupsDevicesPartialUpdateRequest {
	return ApiPermissionsGroupsDevicesPartialUpdateRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
*/
func (a *PermissionsAPIService) PermissionsGroupsDevicesUpdate(ctx context.Context, id int32, nameOrId string) ApiPermissionsGroupsDevicesUpdateRequest {
	return ApiPermissionsGroupsDevicesUpdateRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
*/
func (a *PermissionsAPIService) PermissionsGroupsLabelsCreate(ctx context.Context, nameOrId string) ApiPermissionsGroupsLabelsCreateRequest {
	return ApiPermissionsGroupsLabelsCreateRequest{
		ApiService: a,
		ctx: ctx,
		nameOrId: nameOrId,
...
func (a *PermissionsAPIService) PermissionsGroupsLabelsCreateExecute(r ApiPermissionsGroupsLabelsCreateRequest) (*PermissionGroup, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/permissions/groups/{name_or_id}/labels/"
	localVarPath = strings.Replace(localVarPath, "{"+"name_or_id"+"}", url.PathEscape(parameterValueToString(r.nameOrId, "nameOrId")), -1)
...
*/
func (a *PermissionsAPIService) PermissionsGroupsLabelsDestroy(ctx context.Context, id int32, nameOrId string) ApiPermissionsGroupsLabelsDestroyRequest {
	return ApiPermissionsGroupsLabelsDestroyRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
func (a *PermissionsAPIService) PermissionsGroupsLabelsDestroyExecute(r ApiPermissionsGroupsLabelsDestroyRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/api/permissions/groups/{name_or_id}/labels/{id}/"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"name_or_id"+"}", url.PathEscape(parameterValueToString(r.nameOrId, "nameOrId")), -1)
...
*/
func (a *PermissionsAPIService) PermissionsGroupsLabelsList(ctx context.Context, nameOrId string) ApiPermissionsGroupsLabelsListRequest {
	return ApiPermissionsGroupsLabelsListRequest{
		ApiService: a,
		ctx: ctx,
		nameOrId: nameOrId,
...
*/
func (a *PermissionsAPIService) PermissionsGroupsLabelsPartialUpdate(ctx context.Context, id int32, nameOrId string) ApiPermissionsGroupsLabelsPartialUpdateRequest {
	return ApiPermissionsGroupsLabelsPartialUpdateRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
*/
func (a *PermissionsAPIService) PermissionsGroupsLabelsUpdate(ctx context.Context, id int32, nameOrId string) ApiPermissionsGroupsLabelsUpdateRequest {
	return ApiPermissionsGroupsLabelsUpdateRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
...
type ApiPermissionsGroupsPartialUpdateRequest struct {
	ctx context.Context
	ApiService *PermissionsAPIService
	nameOrId string
	patchedPermissionGroup *PatchedPermissionGroup
}

func (r ApiPermissionsGroupsPartialUpdateRequest) PatchedPermissionGroup(patchedPermissionGroup PatchedPermissionGroup) ApiPermissionsGroupsPartialUpdateRequest {
	r.patchedPermissionGroup = &patchedPermissionGroup
	return r
}

func (r ApiPermissionsGroupsPartialUpdateRequest) Execute() (*PermissionGroup, *http.Response, error) {
	return r.ApiService.PermissionsGroupsPartialUpdateExecute(r)
}

/*
PermissionsGroupsPartialUpdate Method for PermissionsGroupsPartialUpdate

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param nameOrId
 @return ApiPermissionsGroupsPartialUpdateRequest
*/
func (a *PermissionsAPIService) PermissionsGroupsPartialUpdate(ctx context.Context, nameOrId string) ApiPermissionsGroupsPartialUpdateRequest {
	return ApiPermissionsGroupsPartialUpdateRequest{
		ApiService: a,
		ctx: ctx,
		nameOrId: nameOrId,
...
// Execute executes the request
//  @return PermissionGroup
func (a *PermissionsAPIService) PermissionsGroupsPartialUpdateExecute(r ApiPermissionsGroupsPartialUpdateRequest) (*PermissionGroup, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPatch
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PermissionsAPIService.PermissionsGroupsPartialUpdate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	// body params
	localVarPostBody = r.patchedPermissionGroup
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["tokenAuth"]; ok {
...
*/
func (a *PermissionsAPIService) PermissionsGroupsRetrieve(ctx context.Context, nameOrId string) ApiPermissionsGroupsRetrieveRequest {
	return ApiPermissionsGroupsRetrieveRequest{
		ApiService: a,
		ctx: ctx,
		nameOrId: nameOrId,
...
type ApiPermissionsGroupsUpdateRequest struct {
	ctx context.Context
	ApiService *PermissionsAPIService
	nameOrId string
	permissionGroup *PermissionGroup
...
func (r ApiPermissionsGroupsUpdateRequest) PermissionGroup(permissionGroup PermissionGroup) ApiPermissionsGroupsUpdateRequest {
	r.permissionGroup = &permissionGroup
	return r
}

func (r ApiPermissionsGroupsUpdateRequest) Execute() (*PermissionGroup, *http.Response, error) {
	return r.ApiService.PermissionsGroupsUpdateExecute(r)
}

/*
PermissionsGroupsUpdate Method for PermissionsGroupsUpdate

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param nameOrId
 @return ApiPermissionsGroupsUpdateRequest
*/
func (a *PermissionsAPIService) PermissionsGroupsUpdate(ctx context.Context, nameOrId string) ApiPermissionsGroupsUpdateRequest {
	return ApiPermissionsGroupsUpdateRequest{
		ApiService: a,
		ctx: ctx,
		nameOrId: nameOrId,
...
// Execute executes the request
//  @return PermissionGroup
func (a *PermissionsAPIService) PermissionsGroupsUpdateExecute(r ApiPermissionsGroupsUpdateRequest) (*PermissionGroup, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PermissionsAPIService.PermissionsGroupsUpdate")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *PermissionsAPIService) PermissionsGroupsUsersCreate(ctx context.Context, nameOrId string) ApiPermissionsGroupsUsersCreateRequest {
	return ApiPermissionsGroupsUsersCreateRequest{
		ApiService: a,
		ctx: ctx,
		nameOrId: nameOrId,
...
func (a *PermissionsAPIService) PermissionsGroupsUsersCreateExecute(r ApiPermissionsGroupsUsersCreateRequest) (*PermissionGroup, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/permissions/groups/{name_or_id}/users/"
	localVarPath = strings.Replace(localVarPath, "{"+"name_or_id"+"}", url.PathEscape(parameterValueToString(r.nameOrId, "nameOrId")), -1)
...
*/
func (a *PermissionsAPIService) PermissionsGroupsUsersDestroy(ctx context.Context, nameOrId string, usernameOrId string) ApiPermissionsGroupsUsersDestroyRequest {
	return ApiPermissionsGroupsUsersDestroyRequest{
		ApiService: a,
		ctx: ctx,
		nameOrId: nameOrId,
...
func (a *PermissionsAPIService) PermissionsGroupsUsersDestroyExecute(r ApiPermissionsGroupsUsersDestroyRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/api/permissions/groups/{name_or_id}/users/{username_or_id}/"
	localVarPath = strings.Replace(localVarPath, "{"+"name_or_id"+"}", url.PathEscape(parameterValueToString(r.nameOrId, "nameOrId")), -1)
