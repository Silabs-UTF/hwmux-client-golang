...
// checks if the PaginatedPartList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedPartList{}
...
func (o PaginatedPartList) ToMap() (map[string]interface{}, error) {
