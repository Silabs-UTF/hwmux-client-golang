...
type ReservationSessionSerializerReadOnly struct {
	...
	State NullableReservationSessionSerializerReadOnlyState `json:"state"`
...
// If the value is explicit nil, the zero value for ReservationSessionSerializerReadOnlyState will be returned
func (o *ReservationSessionSerializerReadOnly) GetState() ReservationSessionSerializerReadOnlyState {
	if o == nil || o.State.Get() == nil {
		var ret ReservationSessionSerializerReadOnlyState
		return ret
	}
