...
// checks if the PatchedPart type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedPart{}
...
func (o PatchedPart) ToMap() (map[string]interface{}, error) {
