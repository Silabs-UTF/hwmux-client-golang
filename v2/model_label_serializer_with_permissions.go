...
// checks if the LabelSerializerWithPermissions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LabelSerializerWithPermissions{}
...
type _LabelSerializerWithPermissions LabelSerializerWithPermissions
...
func (o LabelSerializerWithPermissions) ToMap() (map[string]interface{}, error) {
...
func (o *LabelSerializerWithPermissions) UnmarshalJSON(bytes []byte) (err error) {
	...
	varLabelSerializerWithPermissions := _LabelSerializerWithPermissions{}

	err = json.Unmarshal(bytes, &varLabelSerializerWithPermissions)

	if err != nil {
		return err
	}

	*o = LabelSerializerWithPermissions(varLabelSerializerWithPermissions)
