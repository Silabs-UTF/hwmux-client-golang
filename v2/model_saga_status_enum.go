...
const (
	STARTED SagaStatusEnum = "started"
	FAILED SagaStatusEnum = "failed"
	SUCCEEDED SagaStatusEnum = "succeeded"
	PROCESSING SagaStatusEnum = "processing"
	COMPENSATING SagaStatusEnum = "compensating"
	COMPENSATED SagaStatusEnum = "compensated"
)
