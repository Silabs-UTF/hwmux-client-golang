...
// checks if the PatchedDeviceGroupSerializerWithDevicePk type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedDeviceGroupSerializerWithDevicePk{}
...
func (o PatchedDeviceGroupSerializerWithDevicePk) ToMap() (map[string]interface{}, error) {
