...
// checks if the DeviceSerializerPublic type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceSerializerPublic{}
...
type _DeviceSerializerPublic DeviceSerializerPublic
...
func (o DeviceSerializerPublic) ToMap() (map[string]interface{}, error) {
...
func (o *DeviceSerializerPublic) UnmarshalJSON(bytes []byte) (err error) {
	...
	varDeviceSerializerPublic := _DeviceSerializerPublic{}

	err = json.Unmarshal(bytes, &varDeviceSerializerPublic)

	if err != nil {
		return err
	}

	*o = DeviceSerializerPublic(varDeviceSerializerPublic)
