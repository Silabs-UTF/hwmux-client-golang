...
// checks if the PaginatedDeviceSerializerPublicList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedDeviceSerializerPublicList{}
...
func (o PaginatedDeviceSerializerPublicList) ToMap() (map[string]interface{}, error) {
