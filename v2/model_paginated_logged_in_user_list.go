...
// checks if the PaginatedLoggedInUserList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedLoggedInUserList{}
...
func (o PaginatedLoggedInUserList) ToMap() (map[string]interface{}, error) {
